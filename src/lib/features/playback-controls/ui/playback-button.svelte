...
<IconButton
  ...
  class={prominent ? 'w-14 h-14 bg-gradient-to-br from-violet-500 to-blue-600 hover:from-violet-400 hover:to-blue-500' : 'w-6 h-6'}
  iconClass={prominent ? 'w-7 h-7' : 'w-4 h-4'}
  on:click
/>
